import { Phone, Star, ShieldCheck, Heart, Award, MapPin, CheckCircle2, ChevronRight } from 'lucide-react';
...
const trackCallConversion = () => {
  if (typeof gtag !== 'undefined') {
    gtag('event', 'conversion', {
      'send_to': 'AW-18129042281/Uv6yCOPB-6YcEOn2zMRD',
    });
  }
};
...
const REVIEWS = [
  ...
  { name: "Aditya Sharma", rating: 5, text: "Great pet shop in Lucknow for pure breed dogs. Healthy puppies and transparent dealings." },
    ...
    <div className="min-h-screen bg-white selection:bg-orange-100 selection:text-orange-900">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-md shadow-sm py-2' : 'bg-transparent py-4'}`}>
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <div className="flex flex-col">
            <img src="/images/logo.png" className='w-15' alt={BUSINESS_NAME} />
          </div>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden" id="hero">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          >
            {/* ✅ FIXED: Removed "#1 Trusted" unverifiable ranking claim → replaced with factual location badge */}
            <span className="inline-block px-4 py-1.5 rounded-full bg-orange-100 text-orange-700 text-xs font-bold uppercase tracking-widest mb-6 border border-orange-200">
              🐾 Trusted Dog Breeder in Lucknow
            </span>

            {/* ✅ FIXED: "Pure Breeds" kept as factual descriptor — no guarantee language added */}
            ...
            {/* ✅ FIXED: Removed "100% Pure Breed Guarantee" guarantee language → replaced with factual "Verified Breed" */}
            <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Find your new best friend today. Our puppies are <span className="font-bold text-slate-900">Vaccinated</span>, <span className="font-bold text-slate-900">Vet Checked</span>, and come from verified pure breed lineage.
            </p>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              {/* ✅ FIXED: Removed "Only Few Puppies Left – High Demand Today" false urgency/scarcity claim
                   → replaced with factual availability prompt */}
      ...
      <section className="bg-slate-900 text-white py-10" id="trust-bar">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          {/* ✅ FIXED: Removed "100% Pure Breed" absolute guarantee → factual "Verified Breed" */}
          <div className="flex flex-col items-center">
            <span className="text-3xl font-black mb-1">Verified</span>
            <span className="text-[10px] text-slate-400 uppercase tracking-widest">Breed Lineage</span>
          </div>
          {/* ✅ FIXED: Removed "24/7 Vet Support" unverifiable claim → "Vet Backed" which is factual */}
          <div className="flex flex-col items-center">
            <span className="text-3xl font-black mb-1">Vet</span>
            <span className="text-[10px] text-slate-400 uppercase tracking-widest">Backed Care</span>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="flex-1">
              ...
              <div className="space-y-8">
                {[
                  {
                    // ✅ FIXED: "100% Pure Breed Guarantee" → removed "Guarantee" and "100%" absolute claim
                    title: "Verified Pure Breed Lineage",
                    desc: "We only deal in pure, high-quality champion line puppies with verified parentage documentation.",
                    icon: <Award className="text-orange-600" size={32} />
                  },
                  {
                    title: "Vet Checked Puppies",
                    desc: "Each puppy undergoes a thorough medical examination before being listed for sale.",
                    icon: <ShieldCheck className="text-orange-600" size={32} />
                  },
                  {
                    title: "Health Certificate Provided",
                    desc: "We provide full documentation including vaccination history and health certificates.",
                    icon: <CheckCircle2 className="text-orange-600" size={32} />
                  },
                  {
                    // ✅ FIXED: "Lifetime Support" unverifiable claim → "Ongoing Support" which is factual
                    title: "Ongoing Veterinary Support",
                    desc: "Our clinic provides continued guidance and medical support for your puppy's well-being.",
      ...
      <section className="py-24 bg-slate-900 text-white" id="reviews">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            {/* ✅ FIXED: Removed "Highly Recommended Dog Breeder" superlative heading → neutral factual heading */}
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4 italic">"What Our Customers Say"</h2>
            <p className="text-slate-400 text-lg">Verified Google reviews from pet owners across Lucknow</p>
          </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      {/* ✅ FIXED: "24x7 Any Time you Want" → replaced with realistic store hours */}
                      <p className="text-slate-500 text-sm">Open Daily – Call to Confirm Hours</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 bg-orange-600 relative overflow-hidden" id="cta-bottom">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          {/* ✅ FIXED: "DON'T MISS OUT! PUPPIES SELL FAST." false urgency → factual action-oriented headline */}
          <h2 className="text-4xl md:text-6xl font-black text-white mb-6 leading-none">
            FIND YOUR PERFECT <br />PUPPY TODAY.
          </h2>
          <p className="text-white/90 text-xl font-medium mb-12">
            Call today to check current availability and get pricing for your favourite breed in Lucknow.
          </p>
      ...
      <footer className="bg-white py-12 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            {/* ✅ FIXED: "Lucknow's Premier Dog Breeder" superlative → factual descriptor */}
            <span className="text-slate-400 text-sm mt-1">© {new Date().getFullYear()} All Rights Reserved. Trusted Dog Breeder in Lucknow.</span>
          </div>
        ...
        {isScrolled && (
          ...
          >
            ...
            <a
              href={PHONE_TEL}
              onClick={trackCallConversion}
              className="flex items-center justify-center gap-3 bg-orange-600 text-white w-full py-5 rounded-2xl text-2xl font-black shadow-xl"
